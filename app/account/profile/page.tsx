		...
		<div className="grid grid-cols-4 px-9 h-screen pt-[94px] gap-[50px]">
			<div className="col-span-1 flex flex-col gap-[50px]">
				...
				<div className="bg-white p-[30px] rounded-[32px] flex flex-col gap-3">
					...
					{me?.sex?.male ? (
						<div className="flex items-center gap-2 cursor-pointer group transition-all">
							<LuCrown className="text-primary" size={16} />
							<p className="mt-px group-hover:text-primary">
					...
					<div className="flex items-center gap-2 cursor-pointer group transition-all">
						<IoArrowUp className="text-primary" size={16} />
						<p className="mt-px group-hover:text-primary">Поднять анкету</p>
					</div>

					<div className="flex items-center gap-2 cursor-pointer group transition-all">
						<LuWallet className="text-primary" size={16} />
						<p className="mt-px group-hover:text-primary">Пополнить кошелек</p>
					</div>

					<div className="flex items-center gap-2 cursor-pointer group transition-all mt-4">
						<LuTrash className="text-primary" size={16} />
						<p className="mt-px group-hover:text-primary">Удалить анкету</p>
					</div>

					<button
						className="flex items-center gap-2 cursor-pointer group transition-all mt-4"
						onClick={logout}
					>
						<MdOutlineLogout className="text-primary" size={16} />
						<p className="mt-px group-hover:text-primary">Выйти</p>
					</button>
				</div>
			</div>
			<div className="col-span-3 flex flex-col">
				<div className="bg-white p-9 rounded-[32px] flex flex-col gap-5">
