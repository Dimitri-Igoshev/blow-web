...
export default function AccountSearch() {
  ...
  return (
    <div className="flex w-full flex-col px-3 sm:px-9 pt-[434px] sm:pt-[220px] gap-[30px]">
      {users ? (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-[34px] mt-[16px] sm:mt-0">
            {users.map((item: any) => (
